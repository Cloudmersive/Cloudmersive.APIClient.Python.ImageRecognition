...
[**resize_resize_image_helper_max_width**](ResizeApi.md#resize_resize_image_helper_max_width) | **POST** /api/Resize | 
...
# **resize_resize_image_helper_max_width**
> str resize_resize_image_helper_max_width(input, max_width)
