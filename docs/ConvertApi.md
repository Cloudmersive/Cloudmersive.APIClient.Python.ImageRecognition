# cloudmersive_image_api_client.ConvertApi
...
try:
    # Convert input image to Bitmap BMP format
    api_response = api_instance.convert_to_bmp(image_file)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ConvertApi->convert_to_bmp: %s\n" % e)
```
...
# **convert_to_jpg**
> str convert_to_jpg(quality, image_file)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **quality** | **int**| Set the JPEG quality level; lowest quality is 1 (highest compression), highest quality (lowest compression) is 100; recommended value is 75 | 
 **image_file** | **file**| Image file to perform the operation on.  Common file formats such as PNG, JPEG are supported. | 
...
try:
    # Convert input image to JPG, JPEG format
    api_response = api_instance.convert_to_jpg_default_quality(image_file)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ConvertApi->convert_to_jpg_default_quality: %s\n" % e)
```
...
> str convert_to_photoshop(image_file)
...
try:
    # Convert input image to PNG format
    api_response = api_instance.convert_to_png(image_file)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ConvertApi->convert_to_png: %s\n" % e)
```
...
# **convert_to_tiff**
> str convert_to_tiff(image_file)
...
try:
    # Convert input image to TIFF format
    api_response = api_instance.convert_to_tiff(image_file)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ConvertApi->convert_to_tiff: %s\n" % e)
```
...
# **convert_to_web_p**
> str convert_to_web_p(image_file)
...
try:
    # Convert input image to WebP format
    api_response = api_instance.convert_to_web_p(image_file)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ConvertApi->convert_to_web_p: %s\n" % e)
```
