...
class ResizeApi(object):
    ...
    def resize_resize_ai_super_sampling(self, image_file, **kwargs):  # noqa: E501
        """Resize an image with AI super sampling  # noqa: E501

        Use AI super sampling to resize a small or low resolution image to twice the size.  Input image should be PNG or JPG, and smaller than 200 x 200 pixels (larger images will be resized down).  Consumes 20 API calls.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.resize_resize_ai_super_sampling(image_file, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.resize_resize_ai_super_sampling_with_http_info(image_file, **kwargs)  # noqa: E501
        else:
            (data) = self.resize_resize_ai_super_sampling_with_http_info(image_file, **kwargs)  # noqa: E501
            return data

    def resize_resize_ai_super_sampling_with_http_info(self, image_file, **kwargs):  # noqa: E501
        """Resize an image with AI super sampling  # noqa: E501

        Use AI super sampling to resize a small or low resolution image to twice the size.  Input image should be PNG or JPG, and smaller than 200 x 200 pixels (larger images will be resized down).  Consumes 20 API calls.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.resize_resize_ai_super_sampling_with_http_info(image_file, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method resize_resize_ai_super_sampling" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'image_file' is set
        if ('image_file' not in params or
                params['image_file'] is None):
            raise ValueError("Missing the required parameter `image_file` when calling `resize_resize_ai_super_sampling`")  # noqa: E501
