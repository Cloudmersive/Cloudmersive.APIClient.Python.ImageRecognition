...
api_instance = cloudmersive_image_api_client.ArtisticApi()
...
*ResizeApi* | [**resize_resize_image_helper_max_width**](docs/ResizeApi.md#resize_resize_image_helper_max_width) | **POST** /api/Resize | 
